...
var connectionString = builder.Configuration.GetConnectionString("Identity_ContextConnection") ?? throw new InvalidOperationException("Connection string 'Identity_ContextConnection' not found.");

builder.Services.AddDbContext<Identity_Context>(options =>
    options.UseSqlServer(connectionString));

builder.Services.AddDefaultIdentity<PetProject_User>(options => options.SignIn.RequireConfirmedAccount = false)
